...
namespace Socialite\HyperfSocialite;

use Hyperf\Contract\ConfigInterface;
use Hyperf\HttpServer\Contract\RequestInterface;
use InvalidArgumentException;
use League\OAuth1\Client\Server\Server as OAuth1Server;
use Socialite\HyperfSocialite\One\AbstractProvider as SocialiteOAuth1AbstractProvider;
use Socialite\HyperfSocialite\Two\AbstractProvider as SocialiteOAuth2AbstractProvider;
